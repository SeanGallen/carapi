...
namespace getVehicleLocationAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          //  var connection = @"Server=(localdb)\mssqllocaldb;Database=GeoLocations.AspNetCore.NewDb;Trusted_Connection=True;";
            var connection = @"Server=(localdb)\mssqllocaldb;Database=GeoLocations.AspNetCore.NewDb;User Id=sa;Password=glen;";
