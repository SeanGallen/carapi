...
namespace getVehicleLocationAPI.ServiceFunctionality
{
    public class PostCheck
    {
        ...
        {
            _context = context;
            _context.VechicleLocations.Add(vehicleLocation);
            ...
            _context.VechicleLocations.Update(vehicleLocation);
        ...
        {
            _context = context;
            var response = await _context.VechicleLocations.SingleOrDefaultAsync(m => m.VehicleLatLong == vehicleLocation.VehicleLatLong);
        ...
        {
            return _context.VechicleLocations.Any(e => e.VehicleLatLong == id);
        }
